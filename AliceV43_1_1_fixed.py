...
# ==========================================
AGENT_NAME = os.environ.get("AGENT_NAME", "ALICE").upper()
...
if AGENT_NAME == "ALICE":
    ...
    SUB_MODEL    = os.environ.get("ZORON_SUB_MODEL", "deepseek-r1:1.5b")
    CON_MODEL    = os.environ.get("ZORON_CON_MODEL", "gemma3:1b")
    SPARK_MODEL  = VOICE_MODEL
...
def extract_send_message(text: str):
    ...
    # Normalize common markdown emphasis around SEND lines
    ...
    # Multi-line SEND block: first non-empty line is SEND, remainder is the message
